    ...
    <div class="wrap-contact100">
        <form class="contact100-form validate-form" method="post">
            ...
            <div class="container-contact100-form-btn">
                <input class="bg-sky-500 contact100-form-btn" type="submit" name="login" value="login">
            </div>
            <div class="container-contact100-form-btn">
                <input class="bg-sky-500 contact100-form-btn" type="submit" name="adminlogin" value="Admin login">
            </div>
        </form>
    </div>
    </div>
